 ...
 *
 */
public class DrViewFeedback extends javax.swing.JFrame {
    String doctorName, date, time, department;
    int appRate;
    String appComment;
...
>>>>>>> main
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DrViewFeedback().setVisible(true);
            }
        });
    }
    ...
    private void displayAppointment(){
        try{
            ...
            String sql = "SELECT * FROM Appointment WHERE FirstFB=0 AND DoctorID = ?";
