 ...
 * 
 */
public class DrView1Feedback extends javax.swing.JFrame {
    int appRate;
    String doctorName, doctorID, date, time, department, feedback;
    int appointmentID = DrManageAppointment.appointmentID;
    int patientID = DrManageAppointment.patientID;
    /**
     * Creates new form Ratings
     */

    public DrView1Feedback() {
        initComponents();
        displayDoctorInfo();
        displayPatientInfo();
...
>>>>>>> main
        ...
        AppointID.setText("                            ");
        jPanel2.add(AppointID, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 20, 90, -1));
        ...
        jPanel6.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 60, 80, 20));

        patient_id.setBackground(new java.awt.Color(255, 255, 255));
        patient_id.setFont(new java.awt.Font("Cambria", 0, 14)); // NOI18N
        patient_id.setText("                       ");
        jPanel6.add(patient_id, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 60, 139, -1));
...
>>>>>>> main
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DrView1Feedback.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DrView1Feedback().setVisible(true);
            }
        });
    }
