 ...
 * @author Admin
 */
public class MedRecord extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MedRecord.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
//                try {
                    new MedRecord().setVisible(true);
//                } catch (ClassNotFoundException ex) {
//                    Logger.getLogger(MedRecord.class.getName()).log(Level.SEVERE, null, ex);
