...
//                    average_rating.setText(averageRate);
    ...
    private void initComponents() {
        ...
        jPanel5.add(doctor_name, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 170, -1, -1));
        ...
        jPanel2.add(lbl_date, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 40, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ratings2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
