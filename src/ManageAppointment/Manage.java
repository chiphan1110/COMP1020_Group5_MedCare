...
public class Manage extends javax.swing.JFrame {
    ...
    public Manage() {
        initComponents();
        getPatientInfo();
//        Object columns[] = {"Appointment ID", "Date", "Time", "Doctor", "Status"};
...
//    public int userID = Login.userid;
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Appointment ID", "Date", "Time", "Doctor"
            }
        ) {
        ...
        mainboardLayout.setVerticalGroup(
            ...
            .addGroup(mainboardLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(mainboardLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(dateOfBirthLabel1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(mainboardLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addGroup(mainboardLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel2)
                    .addComponent(ApointmentBT, javax.swing.GroupLayout.DEFAULT_SIZE, 26, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void BackButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BackButtonActionPerformed
        ...
        Dashboard.Home home = new Dashboard.Home();
        home.show();
        this.dispose();
        ...
        try{
            ...
            */
            ...
            while (rs2.next()){
                ...
                String tbData[] = {id, D, Time, Doctor};
            ...
            */
            ...
            while (rs3.next()){
                ...
                //                String Stat = rs.getString("Status");
                String tb2Data[] = {id, D, Time, Doctor};
